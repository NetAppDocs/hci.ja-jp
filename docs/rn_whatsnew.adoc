...
NOTE: Element ソフトウェア 12.9 は最新リリースであり、セキュリティとシステム コンポーネントの更新、運用の改善、および解決された問題が含まれています。 https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["Element 12.9の新機能について詳しく見る"^] 。
