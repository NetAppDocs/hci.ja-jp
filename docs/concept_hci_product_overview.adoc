...
| https://[management ノード IP アドレス | NetApp Hybrid Cloud Control にアクセスして、 NetApp HCI のインストール、拡張、監視、管理サービスの更新を行うことができます。 link:task_hci_getstarted.html["詳細はこちら。"] 


| 「 https://[IP アドレス」： 442` | ノード UI から、ネットワークとクラスタの設定にアクセスし、システムのテストとユーティリティを利用できます。 https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-35DD1677-05FE-4396-9654-343137102D3D.html["詳細はこちら。"] 
