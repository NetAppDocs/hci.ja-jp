...
---
= バージョン 1.9 または 1.9P1 の NetApp HCI システムをアップグレードします
...
. link:task_hcc_upgrade_compute_node_firmware.html["NetApp Hybrid Cloud Control を使用してコンピューティングノードのファームウェアを更新します"] または 。
