...
. （ NetApp Element Plug-in for vCenter Server を使用したすべての NetApp HCI インストールおよび SolidFire オールフラッシュストレージインストールの場合）に記載されている手順に従って、 12.3 管理ノードの vCenter Plug-in を更新します link:task_vcp_upgrade_plugin.html["Element Plug-in for vCenter Server をアップグレードします"] トピック：
