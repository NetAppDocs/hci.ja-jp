...
| 管理ノード | 「 po.netapp.com/api/repos/netapp-downloads` 」、「 po.netapp.com/bintray/dl/` 」、「 po.netapp.com/bintray/api/package` netapp-downloads.bintray.com 」、「 bintray.com 」、「 re po.netapp.com` 」、「 library.netapp.com` 」 | 443 | 管理ノードサービスのアップグレード 
