...
* link:task_hcc_upgrade_all.html["バージョン 1.8 の NetApp HCI インストールをアップグレードします"]。
* link:task_sf_upgrade_all.html["Element 12.2 で NetApp SolidFire オールフラッシュストレージシステムをアップグレードします"]。
