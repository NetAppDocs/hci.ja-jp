...
作業を開始するには、に移動します https://github.com/NetApp/ansible/tree/master/nar_compute_nodes_firmware_upgrades["GitHub 上の NetApp Ansible リポジトリ"^] および 'NAR_compute_nodes _firmware_upgrades ロールとドキュメントをダウンロードします
